/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 9cd8b035a78a6d04c769650faaf30adc)
// Runtime types generated with workerd@1.20260911.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	AUTH_LIMIT: RateLimit;
	AI_LIMIT: RateLimit;
	ASSETS: Fetcher;
	AUTH_ORIGIN: "https://poietra.com";
	...
	AUTH_RECORDS: DurableObjectNamespace<import("./index").AuthRecord>;
	USER_ACCOUNTS: DurableObjectNamespace<import("./index").UserAccount>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ProjectRoom" | "AuthRecord" | "UserAccount";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ORIGIN" | "OPENAI_MODEL" | "OPENAI_IMAGE_MODEL" | "OPENAI_IMAGE_QUALITY" | "OPENAI_REASONING_EFFORT" | "OPENAI_SERVICE_TIER" | "OPENAI_API_KEY">> {}
}
